...
const CameraFormComponent = ({ form, handleChange, handleSubmit, buttonLabel }) => {
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit} className="form-grid">
        ...
        <div className="form-group">
          ...
          <input type="text" name="cameraSerialNumber" value={form.cameraSerialNumber} onChange={handleChange} />
        </div>
        <div className="form-group">
          <label>Name</label>
